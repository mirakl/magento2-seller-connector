...
class OrderTest extends TestCase
{
    ...
    public function testCreateOrderWithTaxes()
    {
        ...
        $this->assertSame('TVA5.5_1', $orderTaxItem1['code']);
        $this->assertSame('VAT', $orderTaxItem1['title']);
        ...
        $this->assertSame('TVA5.5_1', $orderTaxItem2['code']);
        $this->assertSame('VAT', $orderTaxItem2['title']);
        ...
        $this->assertSame('TVA5.5_1', $orderTaxItem3['code']);
        $this->assertSame('VAT', $orderTaxItem3['title']);
        ...
        $this->assertSame('TVA20_1', $orderTaxItem4['code']);
        $this->assertSame('VAT', $orderTaxItem4['title']);
        ...
        $this->assertSame('TVA20_1', $orderTaxItem5['code']);
        $this->assertSame('VAT', $orderTaxItem5['title']);
        ...
        $this->assertSame('TVA20_1', $orderTaxItem6['code']);
        $this->assertSame('VAT', $orderTaxItem6['title']);
